...
export function HealthMonitoringDashboard() {
  ...
  return (
    <Section id="monitoring" className="bg-gray-900 text-white">
      <motion.div
        ref={ref}
...
export function PersonalizedCareTools() {
  ...
  return (
    <Section id="care" className="bg-gray-800 border-t border-white/10 relative overflow-hidden">
...
export function EmergencySupport() {
  ...
  return (
    <Section id="support" className="bg-gray-900 text-white">
      <motion.div ref={ref} initial={{ opacity: 0, y: 50 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
        <div className="mb-16 max-w-3xl">
          ...
          <p className="text-gray-300 text-lg italic">Comprehensive support system ensuring you're never alone in your heart health journey.</p>
        </div>
...
export function HealthInsights() {
  ...
  return (
    <Section id="insights" className="bg-gray-800 border-t border-white/10">
      <motion.div ref={ref} initial={{ opacity: 0, y: 50 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
        <div className="mb-16 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">HEALTH INSIGHTS & ANALYTICS</h2>
          <p className="text-gray-300 italic">Understand your heart health patterns and track your progress over time.</p>
        </div>
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? 'visible' : 'hidden'} className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <motion.div variants={scaleIn} whileHover={{ scale: 1.02, y: -5 }} className="bg-gray-900/80 backdrop-blur-sm border border-white/10 p-10 flex flex-col rounded-3xl shadow-2xl hover:shadow-red-600/10 transition-all">
            ...
            <h3 className="text-2xl font-bold mb-4">Health Trend Analysis</h3>
            <p className="text-gray-300 mb-8 flex-1">Interactive charts showing your heart rate patterns, activity levels, and risk factor trends over time.</p>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.5 }} className="bg-gray-800/80 backdrop-blur-sm border border-white/10 p-6 mb-8 rounded-2xl">
              <div className="flex justify-between items-end mb-2">
                <span className="text-sm font-bold uppercase text-gray-400">Heart Health Score</span>
          ...
          <motion.div variants={scaleIn} whileHover={{ scale: 1.02, y: -5 }} className="bg-gray-900/80 backdrop-blur-sm border border-white/10 p-10 flex flex-col rounded-3xl shadow-2xl hover:shadow-red-600/10 transition-all">
            ...
            <h3 className="text-2xl font-bold mb-4">Lifestyle Impact Tracking</h3>
            <p className="text-gray-300 mb-8 flex-1">Monitor how your daily habits affect your cardiovascular health with detailed analytics and recommendations.</p>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.5 }} className="bg-gray-800/80 backdrop-blur-sm border border-white/10 p-6 mb-8 rounded-2xl">
              ...
              <div className="text-xs text-gray-400 font-mono">WEEKLY_ACTIVITY: 5/7 DAYS // GOAL: 90%</div>
            </motion.div>
            <a href="#" className="inline-flex items-center font-bold uppercase tracking-wider text-sm text-red-400 hover:text-white transition-colors group">
