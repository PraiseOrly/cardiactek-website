      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              Smart monitoring, personalized care, and AI-driven guidance to empower your cardiovascular wellness journey.
            </motion.p>
          ...
          >
            ...
            <div className="relative aspect-square border border-white/20 rounded-3xl p-8 bg-gray-800/50 backdrop-blur-md shadow-2xl">
              <div className="absolute top-0 right-0 p-2 bg-gray-900/80 backdrop-blur-sm border-l border-b border-white/20 rounded-bl-2xl">
                <HeartPulse className="text-red-400 w-4 h-4" />
              </div>
              ...
              <div className="h-full w-full border border-dashed border-white/20 rounded-2xl relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900/50 to-gray-800/50">
                ...
                >
                  <div>AI_MONITORING</div>
                  <div className="text-red-400">STATUS: ACTIVE</div>
                </motion.div>
              </div>
            </div>
          </motion.div>
  ...
  const props = [
    {
      ...
      description:
        'Continuous ECG analysis, wearable integration, and real-time alerts for proactive heart health management.',
      stat: '24/7',
    ...
    },
    {
      ...
      description:
        'AI-driven treatment recommendations, medication tracking, and lifestyle guidance tailored to your needs.',
      stat: '98%',
    ...
    },
    {
      ...
      description:
        'HIPAA-compliant platform with telemedicine access, emergency support, and seamless doctor communication.',
      stat: '100%',
